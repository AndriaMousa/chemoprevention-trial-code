source("functions/plot_sims_distr_deterministic_2strain_function.R")


output<- sims_distr_deterministic_plot_2strain (N_sims= 1000,         ## number of simulated datasets to be generated
...
plot_grid(baseline, red_sample_400, red_followup_42,  red_followup_28, add_AS, add_placebo, 
